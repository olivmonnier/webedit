...
function i(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e,t){var n=[],i=[],o=document.getElementById(e),s=t&&t.editorOptions,l=t&&t.snippetsPath
return(0,f.default)(document),l?(i=Array.isArray(l)?l:[l],n=i.map(function(e){return{url:e.url||e,label:e.label||""}}),Promise.all(n.map(function(e){return fetch(e.url,{method:"GET"})})).then(function(e){Promise.all(e.map(function(e){return e.text()})).then(function(e){(0,a.default)(e,n),(0,r.default)(o)}).then(function(){(0,c.default)(o,s)}).catch(function(e){return console.log(e)})}),{exportHtml:function(){return(0,d.default)(o)}}):void new Error("snippets path missing")}
