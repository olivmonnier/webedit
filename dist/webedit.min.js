...
O(),W(),e&&C.rm(e,"gu-transit"),se&&clearTimeout(se),ue.dragging=!1,le&&ue.emit("out",e,le,G),ue.emit("dragend",e),G=J=re=ie=oe=se=le=null}function H(e,t){var n
...
p=ie,d=G}(null===p&&h||p!==c&&p!==g(c))&&(oe=p,d.insertBefore(c,p),ue.emit("shadow",c,d,G))}}function K(e){C.rm(e,"gu-hide")}function U(e){ue.dragging&&C.add(e,"gu-hide")}function z(){if(!Q){var e=J.getBoundingClientRect()
...
return r}
var O,B={}
n.debuglog=function(e){if(C(O)&&(O=t.env.NODE_DEBUG||""),e=e.toUpperCase(),!B[e])if(new RegExp("\\b"+e+"\\b","i").test(O)){var i=t.pid
...
function i(e){return e&&e.__esModule?e:{default:e}}function o(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:[],t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],n=document.createElement("div")
n.className="w-bar-container",e.forEach(function(e){var t=e.width.replace("px","")||"",i=e.height.replace("px","")||"",o=e.label||t+"x"+i,r=(0,s.default)(o,"w-btn-viewport"),a={width:t,height:i};(0,l.default)(r,a),n.appendChild(r)}),t.forEach(function(e){var t=(0,s.default)(e.label,"w-btn "+(e.class||""),e.id)
t.addEventListener("click",e.fn),n.appendChild(t)}),document.body.appendChild(n)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o
var r=e("./createButton"),s=i(r),a=e("../events/clickBtnViewPort"),l=i(a)},{"../events/clickBtnViewPort":31,"./createButton":19}],19:[function(e,t,n){"use strict"
...
var r=e("./createButton"),s=i(r),a=e("../events/clickBtnDelete"),l=i(a),c=e("../events/clickBtnDuplicate"),u=i(c)},{"../events/clickBtnDelete":27,"../events/clickBtnDuplicate":28,"./createButton":19}],21:[function(e,t,n){"use strict"
...
var r=e("./createContentActions"),s=i(r),a=e("../events/clickContent"),l=i(a)},{"../events/clickContent":32,"./createContentActions":20}],22:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}function o(e){var t=document.createElement("div"),n=(0,s.default)("","w-btn-export fa fa-code")
e.classList.add("w-contents-container"),t.classList.add("w-contents-bar"),(0,l.default)(n,e),t.appendChild(n),e.appendChild(t)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o
var r=e("./createButton"),s=i(r),a=e("../events/clickBtnExport"),l=i(a)},{"../events/clickBtnExport":29,"./createButton":19}],23:[function(e,t,n){"use strict"
...
var r=e("../events/changeSnippetsList"),s=i(r)},{"../events/changeSnippetsList":26}],24:[function(e,t,n){"use strict"
...
var r=e("./createButton"),s=i(r),a=e("./createSelectorSnippets"),l=i(a),c=e("../events/clickBtnOpen"),u=i(c)},{"../events/clickBtnOpen":30,"./createButton":19,"./createSelectorSnippets":23}],25:[function(e,t,n){"use strict"
...
l&&(l.className+=" editable",o.replaceChild((0,s.default)(l,t),n),new a(l,t))}}).on("cancel",function(t,n){e.forEach(function(e){return e.classList.remove("w-hover")})})}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o
var r=e("./components/createContentContainer"),s=i(r),a=e("medium-editor"),l=e("dragula")},{"./components/createContentContainer":21,dragula:9,"medium-editor":12}],26:[function(e,t,n){"use strict"
function i(e){e.addEventListener("change",function(){var e=this.value,t=[].slice.call(document.querySelectorAll(".w-list-snippets"))
t.forEach(function(t){t.getAttribute("data-index")==e?t.classList.remove("w-hide"):t.classList.add("w-hide")})})}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i},{}],27:[function(e,t,n){"use strict"
...
var o=e("../utils/getClosest"),r=i(o),s=e("basicmodal")},{"../utils/getClosest":37,basicmodal:2}],28:[function(e,t,n){"use strict"
...
var o=e("../components/createContentContainer"),r=i(o),s=e("../utils/getClosest"),a=i(s),l=e("../utils/insertAfter"),c=i(l),u=e("medium-editor")},{"../components/createContentContainer":21,"../utils/getClosest":37,"../utils/insertAfter":39,"medium-editor":12}],29:[function(e,t,n){"use strict"
...
a.show({body:"<pre>"+n+"</pre>",class:"modal-export",buttons:{action:{title:"Close",fn:a.close}}})})}
var o=e("../utils/getContents"),r=i(o),s=e("../utils/getClosest"),a=(i(s),e("basicmodal"))},{"../utils/getClosest":37,"../utils/getContents":38,basicmodal:2}],30:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e,t){e.addEventListener("click",function(n){var i=e.classList
i.toggle("in"),t.classList.toggle("in"),i.contains("in")?(i.remove("fa-angle-left"),i.add("fa-angle-right")):(i.remove("fa-angle-right"),i.add("fa-angle-left"))})}},{}],31:[function(e,t,n){"use strict"
...
e.addEventListener("click",function(){window.open(document.location.href,"viewRender",i(n,o))})}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o},{}],32:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e){e.addEventListener("click",function(t){t.stopPropagation(),document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")}),e.classList.add("w-focus")})}},{}],33:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e){e.addEventListener("click",function(){document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")})})}},{}],34:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},n=[],i=[],o=[].slice.call(document.querySelectorAll(e)),s={buttonLabels:"fontawesome",toolbar:{buttons:["bold","italic","underline","strikethrough","anchor","image","quote","justifyLeft","justifyRight","justifyCenter","h1","h2","h3","h4","orderedlist","unorderedlist","indent","outdent","colorPicker","removeFormat"]}},l=t.editorOptions||s,u=t.snippetsPath
return u?(i=Array.isArray(u)?u:[u],n=i.map(function(e){return{url:e.url||e,label:e.label||""}}),Promise.all(n.map(function(e){return fetch(e.url,{method:"GET",mode:"cors"})})).then(function(e){Promise.all(e.map(function(e){return e.text()})).then(function(e){(0,p.default)(document),o.forEach(r.default),(0,c.default)(e,n),(0,a.default)(t.viewports,t.buttons)}).then(function(){(0,d.default)(o,l)}).catch(function(e){return console.log(e)})}),{exportHtml:function(){var e=document.body
return(0,f.default)(e)}}):void new Error("snippets path missing")}
var o=e("./components/createContentsContainer"),r=i(o),s=e("./components/createBarActions"),a=i(s),l=e("./components/createSnippetContainer"),c=i(l),u=e("./dragNDrop"),d=i(u),h=e("./utils/getContents"),f=i(h),m=e("./events/clickDocument"),p=i(m)},{"./components/createBarActions":18,"./components/createContentsContainer":22,"./components/createSnippetContainer":24,"./dragNDrop":25,"./events/clickDocument":33,"./utils/getContents":38}],35:[function(e,t,n){"use strict"
...
n.forEach(function(e,t){var n=(0,r.default)(e,!1)
i[t].innerHTML=n})}
var o=e("./utils/getContents"),r=i(o)},{"./utils/getContents":38}],36:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}var o=e("./initEdit"),r=i(o),s=e("./initRender"),a=i(s)
window&&(window.WebEdit=window.opener?a.default:r.default)},{"./initEdit":34,"./initRender":35}],37:[function(e,t,n){"use strict"
...
return null}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i},{}],38:[function(e,t,n){"use strict"
...
var o=e("htmlencode").htmlEncode},{htmlencode:11}],39:[function(e,t,n){"use strict"
function i(e,t){t.parentNode.insertBefore(e,t.nextSibling)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i},{}]},{},[36])
