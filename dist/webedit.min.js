...
F(e,f(e))}}function B(){ae=!1,a(!0),p(!0)}function O(e){if(B(),ue.dragging){var t=re||J,n=b("clientX",e),i=b("clientY",e),o=l(Q,n,i),r=K(o,n,i)
...
B(),W(),e&&C.rm(e,"gu-transit"),se&&clearTimeout(se),ue.dragging=!1,le&&ue.emit("out",e,le,G),ue.emit("dragend",e),G=J=re=ie=oe=se=le=null}function _(e,t){var n
...
var ue=y({containers:ce.containers,start:L,end:P,cancel:I,remove:R,destroy:v,canMove:N,dragging:!1})
...
return r}
var B,O={}
n.debuglog=function(e){if(C(B)&&(B=t.env.NODE_DEBUG||""),e=e.toUpperCase(),!O[e])if(new RegExp("\\b"+e+"\\b","i").test(B)){var i=t.pid
...
o(n,e),t.className="w-bar-container",t.appendChild(n),document.body.appendChild(t)}},{"../events/clickBtnExport":25,"./createButton":19}],19:[function(e,t,n){"use strict"
...
t.exports=i},{"../events/clickBtnDelete":24,"../events/clickContent":27,"../utils/getClosest":31,"../utils/insertAfter":33,"./createButton":19,"medium-editor":12}],21:[function(e,t,n){"use strict"
var i=e("./createContentActions"),o=e("../events/clickContent")
t.exports=function(e,t){var n=document.createElement("div"),r=i(t)
return o(n),n.className="w-content-container",n.appendChild(r),n.appendChild(e),n}},{"../events/clickContent":27,"./createContentActions":20}],22:[function(e,t,n){"use strict"
...
o(r,t),t.className="w-aside-container",n.id="snippetsContainer",n.innerHTML=e,t.appendChild(r),t.appendChild(n),document.body.appendChild(t)}},{"../events/clickBtnOpen":26,"./createButton":19}],23:[function(e,t,n){"use strict"
...
i.show({body:"<p><strong>Are you sure ?</strong></p>",buttons:{cancel:{title:"Cancel",fn:i.close},action:{title:"Continue",fn:function(){n.remove(),i.close()}}}})})}},{"../utils/getClosest":31,basicmodal:2}],25:[function(e,t,n){"use strict"
var i=e("basicmodal"),o=e("../utils/getContents")
t.exports=function(e,t){e.addEventListener("click",function(e){var n=o(t)
i.show({body:"<pre>"+n+"</pre>",buttons:{action:{title:"Close",fn:i.close}}})})}},{"../utils/getContents":32,basicmodal:2}],26:[function(e,t,n){"use strict"
t.exports=function(e,t){e.addEventListener("click",function(n){var i=e.classList
i.toggle("in"),t.classList.toggle("in"),i.contains("in")?(i.remove("fa-angle-left"),i.add("fa-angle-right")):(i.remove("fa-angle-right"),i.add("fa-angle-left"))})}},{}],27:[function(e,t,n){"use strict"
t.exports=function(e){e.addEventListener("click",function(t){t.stopPropagation(),document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")}),e.classList.add("w-focus")})}},{}],28:[function(e,t,n){"use strict"
t.exports=function(e){e.addEventListener("click",function(){document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")})})}},{}],29:[function(e,t,n){"use strict"
var i=e("./components/createBarActions"),o=e("./components/createSnippetContainer"),r=e("./dragNDrop"),s=e("./utils/getContents"),a=e("./events/clickDocument")
t.exports=function(e,t){var n=document.getElementById(e),l=t&&t.editorOptions,c=t&&t.snippetsPath
return a(document),c?(fetch(c).then(function(e){return e.text()}).then(function(e){o(e),i(n)}).then(function(){r(n,l)}).catch(function(e){return console.log(e)}),{exportHtml:function(){return s(n)}}):void new Error("snippets path missing")}},{"./components/createBarActions":18,"./components/createSnippetContainer":22,"./dragNDrop":23,"./events/clickDocument":28,"./utils/getContents":32}],30:[function(e,t,n){"use strict"
var i=e("./init")
