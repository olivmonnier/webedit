...
a(!0),p(),P(),D(o)
var l=s(J)
Z=b("pageX",e)-l.left,ee=b("pageY",e)-l.top,C.add(re||J,"gu-transit"),z(),j(e)}}}function k(e){if(!(ue.dragging&&Q||n(e))){for(var t=e;f(e)&&n(f(e))===!1;){if(ce.invalid(e,t))return
...
return r}function j(e){function t(e){ue.emit(e,c,le,G)}function n(){h&&t("over")}function i(){le&&t("out")}if(Q){e.preventDefault()
...
Q=J.cloneNode(!0),Q.style.width=d(e)+"px",Q.style.height=h(e)+"px",C.rm(Q,"gu-transit"),C.add(Q,"gu-mirror"),ce.mirrorContainer.appendChild(Q),o(x,"add","mousemove",j),C.add(ce.mirrorContainer,"gu-unselectable"),ue.emit("cloned",Q,J,"mirror")}}function W(){Q&&(C.rm(ce.mirrorContainer,"gu-unselectable"),o(x,"remove","mousemove",j),f(Q).removeChild(Q),Q=null)}function V(e,t){for(var n=t;n!==e&&f(n)!==e;)n=f(n)
...
var i=e("./createButton"),o=e("../utils/getClosest")
t.exports=function(){var e=document.createElement("div"),t=i("","w-btn-move fa fa-arrows"),n=i("","w-btn-delete fa fa-trash")
return n.addEventListener("click",function(e){var t=o(n,".w-content-container")
t.remove()}),e.className="w-actions",e.appendChild(t),e.appendChild(n),e}},{"../utils/getClosest":26,"./createButton":19}],21:[function(e,t,n){"use strict"
var i=e("./createContentActions")
t.exports=function(e){var t=document.createElement("div"),n=i()
return t.className="w-content-container",t.appendChild(n),t.appendChild(e),t}},{"./createContentActions":20}],22:[function(e,t,n){"use strict"
...
l&&(l.className+=" editable",s.replaceChild(r(l),n),new i(l,t))}})}},{"./components/createEditContainer":21,dragula:9,"medium-editor":12}],24:[function(e,t,n){"use strict"
...
return n.forEach(function(e){t+=e.innerHTML}),i(t)}},{htmlencode:11}]},{},[25])
