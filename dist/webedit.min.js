...
o(x,t,"mousemove",k)}function p(e){var t=e?"remove":"add"
...
if(!t){var n=e.target,i=A(n)
i&&(ae=i,a(),"mousedown"===e.type&&(m(n)?n.focus():e.preventDefault()))}}function k(e){if(ae){if(0===r(e))return void B({})
...
a(!0),p(),P(),D(o)
var l=s(J)
Z=b("pageX",e)-l.left,ee=b("pageY",e)-l.top,C.add(re||J,"gu-transit"),z(),K(e)}}}function A(e){if(!(ue.dragging&&Q||n(e))){for(var t=e;f(e)&&n(f(e))===!1;){if(ce.invalid(e,t))return
if(e=f(e),!e)return}var i=f(e)
if(i&&!ce.invalid(e,t)){var o=ce.moves(e,i,t,g(e))
if(o)return{item:e,source:i}}}}function N(e){return!!A(e)}function L(e){var t=A(e)
...
return r}function K(e){function t(e){ue.emit(e,c,le,G)}function n(){h&&t("over")}function i(){le&&t("out")}if(Q){e.preventDefault()
...
p=ie,d=G}(null===p&&h||p!==c&&p!==g(c))&&(oe=p,d.insertBefore(c,p),ue.emit("shadow",c,d,G))}}function q(e){C.rm(e,"gu-hide")}function U(e){ue.dragging&&C.add(e,"gu-hide")}function z(){if(!Q){var e=J.getBoundingClientRect()
Q=J.cloneNode(!0),Q.style.width=d(e)+"px",Q.style.height=h(e)+"px",C.rm(Q,"gu-transit"),C.add(Q,"gu-mirror"),ce.mirrorContainer.appendChild(Q),o(x,"add","mousemove",K),C.add(ce.mirrorContainer,"gu-unselectable"),ue.emit("cloned",Q,J,"mirror")}}function W(){Q&&(C.rm(ce.mirrorContainer,"gu-unselectable"),o(x,"remove","mousemove",K),f(Q).removeChild(Q),Q=null)}function V(e,t){for(var n=t;n!==e&&f(n)!==e;)n=f(n)
...
return ce.removeOnSpill===!0&&ue.on("over",q).on("out",U),i(),ue}function o(e,t,i,o){var r={mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"},s={mouseup:"pointerup",mousedown:"pointerdown",mousemove:"pointermove"},a={mouseup:"MSPointerUp",mousedown:"MSPointerDown",mousemove:"MSPointerMove"}
...
var o=e.util.guid()
t.setAttribute("data-medium-editor-element",!0),t.classList.add("medium-editor-element"),t.setAttribute("role","textbox"),t.setAttribute("aria-multiline",!0),t.setAttribute("data-medium-editor-editor-index",i),t.setAttribute("medium-editor-index",o),A[o]=t.innerHTML,this.events.attachAllEventsToElement(t)}return t}function w(){this.subscribe("editableKeydownTab",i.bind(this)),this.subscribe("editableKeydownDelete",o.bind(this)),this.subscribe("editableKeydownEnter",o.bind(this)),this.options.disableExtraSpaces&&this.subscribe("editableKeydownSpace",t.bind(this)),this.instanceHandleEditableKeydownEnter||(this.options.disableReturn||this.options.disableDoubleReturn)&&(this.instanceHandleEditableKeydownEnter=n.bind(this),this.subscribe("editableKeydownEnter",this.instanceHandleEditableKeydownEnter))}function x(){if(this.extensions=[],Object.keys(this.options.extensions).forEach(function(e){"toolbar"!==e&&this.options.extensions[e]&&this.extensions.push(h(this.options.extensions[e],e,this))},this),y.call(this)){var t=this.options.fileDragging
...
return c&&k.call(this,e.util.getTopBlockContainer(c)),l}return o=n&&n.value,this.options.ownerDocument.execCommand(t,!1,o)}function k(t){if(t){var n,i=Array.prototype.slice.call(t.childNodes).filter(function(e){var t="div"===e.nodeName.toLowerCase()
...
i.parentNode.insertBefore(o,i.nextSibling)}}},this),t.style.textAlign=n,this.restoreSelection())}}var A={}
...
return void(t!==-1&&this.setContent(A[e.getAttribute("medium-editor-index")],t))}this.elements.forEach(function(e,t){this.setContent(A[e.getAttribute("medium-editor-index")],t)},this)},addElements:function(e){var t=c(e,this.options.ownerDocument,!0)
...
return e.forEach(function(e,n){t[e]=!0}),t}function l(e,t,i){if(e.customInspect&&t&&k(t.inspect)&&t.inspect!==n.inspect&&(!t.constructor||t.constructor.prototype!==t)){var o=t.inspect(i,e)
...
if(0===s.length){if(k(t)){var g=t.name?": "+t.name:""
...
if(m(t)&&(b=!0,E=["[","]"]),k(t)){var C=t.name?": "+t.name:""
...
function i(e){return e&&e.__esModule?e:{default:e}}function o(e){var t=document.createElement("div"),n=(0,s.default)("","w-btn-export fa fa-code");(0,l.default)(n,e),t.className="w-bar-container",t.appendChild(n),document.body.appendChild(t)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o
var r=e("./createButton"),s=i(r),a=e("../events/clickBtnExport"),l=i(a)},{"../events/clickBtnExport":26,"./createButton":19}],19:[function(e,t,n){"use strict"
...
var r=e("./createButton"),s=i(r),a=e("../events/clickBtnDelete"),l=i(a),c=e("../events/clickBtnDuplicate"),u=i(c)},{"../events/clickBtnDelete":24,"../events/clickBtnDuplicate":25,"./createButton":19}],21:[function(e,t,n){"use strict"
...
var r=e("./createContentActions"),s=i(r),a=e("../events/clickContent"),l=i(a)},{"../events/clickContent":28,"./createContentActions":20}],22:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}function o(e){var t=document.createElement("div"),n=document.createElement("div"),i=(0,s.default)("","w-btn-open fa fa-angle-left");(0,l.default)(i,t),t.className="w-aside-container",n.id="snippetsContainer",n.innerHTML=e,t.appendChild(i),t.appendChild(n),document.body.appendChild(t)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o
var r=e("./createButton"),s=i(r),a=e("../events/clickBtnOpen"),l=i(a)},{"../events/clickBtnOpen":27,"./createButton":19}],23:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}function o(e,t){l([e,document.getElementById("snippetsContainer")],{copy:function(e,t){return t===document.getElementById("snippetsContainer")},accepts:function(e,t){return t!==document.getElementById("snippetsContainer")},moves:function(t,n,i){return n.id==e.id?i.classList.contains("w-btn-move"):"snippetsContainer"==n.id}}).on("drag",function(t,n){n.id!==e.id&&e.classList.add("w-hover")}).on("drop",function(n,i){if(e.classList.remove("w-hover"),!(n.querySelectorAll(".w-actions").length>0)&&i&&i.id==e.id){var o=n.parentNode,r=n.cloneNode(!0),l=r.querySelectorAll(".w-snippet")[0]
l&&(l.className+=" editable",o.replaceChild((0,s.default)(l,t),n),new a(l,t))}})}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o
var r=e("./components/createEditContainer"),s=i(r),a=e("medium-editor"),l=e("dragula")},{"./components/createEditContainer":21,dragula:9,"medium-editor":12}],24:[function(e,t,n){"use strict"
...
var o=e("../utils/getClosest"),r=i(o),s=e("basicmodal")},{"../utils/getClosest":32,basicmodal:2}],25:[function(e,t,n){"use strict"
...
var o=e("../components/createEditContainer"),r=i(o),s=e("../utils/getClosest"),a=i(s),l=e("../utils/insertAfter"),c=i(l),u=e("medium-editor")},{"../components/createEditContainer":21,"../utils/getClosest":32,"../utils/insertAfter":34,"medium-editor":12}],26:[function(e,t,n){"use strict"
...
s.show({body:"<pre>"+n+"</pre>",buttons:{action:{title:"Close",fn:s.close}}})})}
var o=e("../utils/getContents"),r=i(o),s=e("basicmodal")},{"../utils/getContents":33,basicmodal:2}],27:[function(e,t,n){"use strict"
...
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e){e.addEventListener("click",function(t){t.stopPropagation(),document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")}),e.classList.add("w-focus")})}},{}],29:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e){e.addEventListener("click",function(){document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")})})}},{}],30:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e,t){var n=document.getElementById(e),i=t&&t.editorOptions,o=t&&t.snippetsPath
return(0,f.default)(document),o?(fetch(o).then(function(e){return e.text()}).then(function(e){(0,a.default)(e),(0,r.default)(n)}).then(function(){(0,c.default)(n,i)}).catch(function(e){return console.log(e)}),{exportHtml:function(){return(0,d.default)(n)}}):void new Error("snippets path missing")}
var o=e("./components/createBarActions"),r=i(o),s=e("./components/createSnippetContainer"),a=i(s),l=e("./dragNDrop"),c=i(l),u=e("./utils/getContents"),d=i(u),h=e("./events/clickDocument"),f=i(h)},{"./components/createBarActions":18,"./components/createSnippetContainer":22,"./dragNDrop":23,"./events/clickDocument":29,"./utils/getContents":33}],31:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}var o=e("./init"),r=i(o)
window&&(window.WebEdit=r.default)},{"./init":30}],32:[function(e,t,n){"use strict"
...
return null}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i},{}],33:[function(e,t,n){"use strict"
function i(e){var t="",n=e.querySelectorAll(".w-snippet")
return n.forEach(function(e){t+=e.innerHTML}),o(t)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i
var o=e("htmlencode").htmlEncode},{htmlencode:11}],34:[function(e,t,n){"use strict"
function i(e,t){t.parentNode.insertBefore(e,t.nextSibling)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i},{}]},{},[31])
