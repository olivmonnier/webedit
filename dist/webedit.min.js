...
var i=e("basicmodal"),o=e("./createButton"),r=e("../utils/getContents")
t.exports=function(e){var t=document.createElement("div"),n=o("","w-btn-export fa fa-code")
n.addEventListener("click",function(t){var n=r(e)
i.show({body:"<pre>"+n+"</pre>",buttons:{action:{title:"Close",fn:i.close}}})}),t.className="w-bar-container",t.appendChild(n),document.body.appendChild(t)}},{"../utils/getContents":28,"./createButton":19,basicmodal:2}],19:[function(e,t,n){"use strict"
...
function i(e){var t=document.createElement("div"),n=l("","w-btn-move fa fa-arrows"),i=l("","w-btn-delete fa fa-trash"),s=l("","w-btn-duplicate fa fa-plus")
return o(i),r(s,e),t.className="w-actions",t.appendChild(n),t.appendChild(i),t.appendChild(s),t}function o(e){e.addEventListener("click",function(t){var n=c(e,".w-content-container")
s.show({body:"<p><strong>Are you sure ?</strong></p>",buttons:{cancel:{title:"Cancel",fn:s.close},action:{title:"Continue",fn:function(){n.remove(),s.close()}}}})})}function r(e,t){e.addEventListener("click",function(n){var o=c(e,".w-content-container"),r=o.querySelectorAll(".w-snippet")[0],s=r.innerHTML,l=o.cloneNode(!0),h=l.querySelectorAll(".w-snippet")[0],f=l.querySelectorAll(".w-actions")[0],m=document.createElement("div"),p=i(t)
d(l),f.remove(),h.remove(),m.className="w-snippet editable",m.innerHTML=s,l.appendChild(p),l.appendChild(m),u(l,o),new a(m,t)})}var s=e("basicmodal"),a=e("medium-editor"),l=e("./createButton"),c=e("../utils/getClosest"),u=e("../utils/insertAfter"),d=e("../events/clickContent")
t.exports=i},{"../events/clickContent":24,"../utils/getClosest":27,"../utils/insertAfter":29,"./createButton":19,basicmodal:2,"medium-editor":12}],21:[function(e,t,n){"use strict"
var i=e("./createContentActions"),o=e("../events/clickContent")
t.exports=function(e,t){var n=document.createElement("div"),r=i(t)
return o(n),n.className="w-content-container",n.appendChild(r),n.appendChild(e),n}},{"../events/clickContent":24,"./createContentActions":20}],22:[function(e,t,n){"use strict"
var i=e("./createButton")
t.exports=function(e){var t=document.createElement("div"),n=document.createElement("div"),o=i("","w-btn-open fa fa-angle-left")
o.addEventListener("click",function(e){var n=o.classList
n.toggle("in"),t.classList.toggle("in"),n.contains("in")?(n.remove("fa-angle-left"),n.add("fa-angle-right")):(n.remove("fa-angle-right"),n.add("fa-angle-left"))}),t.className="w-aside-container",n.id="snippetsContainer",n.innerHTML=e,t.appendChild(o),t.appendChild(n),document.body.appendChild(t)}},{"./createButton":19}],23:[function(e,t,n){"use strict"
...
t.exports=function(e){e.addEventListener("click",function(t){t.stopPropagation(),document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")}),e.classList.add("w-focus")})}},{}],25:[function(e,t,n){"use strict"
var i=e("./components/createBarActions"),o=e("./components/createSnippetContainer"),r=e("./dragNDrop"),s=e("./utils/getContents")
t.exports=function(e,t){var n=document.getElementById(e),a=t&&t.editorOptions,l=t&&t.snippetsPath,c=document.getElementsByTagName("body")[0]
return c.addEventListener("click",function(){document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")})}),l?(fetch(l).then(function(e){return e.text()}).then(function(e){o(e),i(n)}).then(function(){r(n,a)}).catch(function(e){return console.log(e)}),{exportHtml:function(){return s(n)}}):void new Error("snippets path missing")}},{"./components/createBarActions":18,"./components/createSnippetContainer":22,"./dragNDrop":23,"./utils/getContents":28}],26:[function(e,t,n){"use strict"
var i=e("./init")
window&&(window.WebEdit=i)},{"./init":25}],27:[function(e,t,n){"use strict"
...
return null}},{}],28:[function(e,t,n){"use strict"
var i=e("htmlencode").htmlEncode
t.exports=function(e){var t="",n=e.querySelectorAll(".w-snippet")
return n.forEach(function(e){t+=e.innerHTML}),i(t)}},{htmlencode:11}],29:[function(e,t,n){"use strict"
t.exports=function(e,t){t.parentNode.insertBefore(e,t.nextSibling)}},{}]},{},[26])
