...
a(!0),p(),P(),D(o)
var l=s(J)
Z=b("pageX",e)-l.left,ee=b("pageY",e)-l.top,C.add(re||J,"gu-transit"),z(),q(e)}}}function N(e){if(!(ue.dragging&&Q||n(e))){for(var t=e;f(e)&&n(f(e))===!1;){if(ce.invalid(e,t))return
if(e=f(e),!e)return}var i=f(e)
if(i&&!ce.invalid(e,t)){var o=ce.moves(e,i,t,g(e))
if(o)return{item:e,source:i}}}}function k(e){return!!N(e)}function L(e){var t=N(e)
...
var ue=y({containers:ce.containers,start:L,end:P,cancel:I,remove:R,destroy:v,canMove:k,dragging:!1})
...
var o=e.util.guid()
t.setAttribute("data-medium-editor-element",!0),t.classList.add("medium-editor-element"),t.setAttribute("role","textbox"),t.setAttribute("aria-multiline",!0),t.setAttribute("data-medium-editor-editor-index",i),t.setAttribute("medium-editor-index",o),N[o]=t.innerHTML,this.events.attachAllEventsToElement(t)}return t}function w(){this.subscribe("editableKeydownTab",i.bind(this)),this.subscribe("editableKeydownDelete",o.bind(this)),this.subscribe("editableKeydownEnter",o.bind(this)),this.options.disableExtraSpaces&&this.subscribe("editableKeydownSpace",t.bind(this)),this.instanceHandleEditableKeydownEnter||(this.options.disableReturn||this.options.disableDoubleReturn)&&(this.instanceHandleEditableKeydownEnter=n.bind(this),this.subscribe("editableKeydownEnter",this.instanceHandleEditableKeydownEnter))}function x(){if(this.extensions=[],Object.keys(this.options.extensions).forEach(function(e){"toolbar"!==e&&this.options.extensions[e]&&this.extensions.push(h(this.options.extensions[e],e,this))},this),y.call(this)){var t=this.options.fileDragging
...
i.parentNode.insertBefore(o,i.nextSibling)}}},this),t.style.textAlign=n,this.restoreSelection())}}var N={}
...
return void(t!==-1&&this.setContent(N[e.getAttribute("medium-editor-index")],t))}this.elements.forEach(function(e,t){this.setContent(N[e.getAttribute("medium-editor-index")],t)},this)},addElements:function(e){var t=c(e,this.options.ownerDocument,!0)
...
i.show({body:"<pre>"+n+"</pre>",buttons:{action:{title:"Close",fn:i.close}}})}),t.className="w-bar-container",t.appendChild(n),document.body.appendChild(t)}},{"../utils/getContents":27,"./createButton":19,basicmodal:2}],19:[function(e,t,n){"use strict"
...
s.show({body:"<p><strong>Are you sure ?</strong></p>",buttons:{cancel:{title:"Cancel",fn:s.close},action:{title:"Continue",fn:function(){n.remove(),s.close()}}}})})}function r(e,t){e.addEventListener("click",function(n){var o=c(e,".w-content-container"),r=o.querySelectorAll(".w-snippet")[0],s=r.innerHTML,l=o.cloneNode(!0),d=l.querySelectorAll(".w-snippet")[0],h=l.querySelectorAll(".w-actions")[0],f=document.createElement("div"),m=i(t)
h.remove(),d.remove(),f.className="w-snippet editable",f.innerHTML=s,l.appendChild(m),l.appendChild(f),u(l,o),new a(f,t)})}var s=e("basicmodal"),a=e("medium-editor"),l=e("./createButton"),c=e("../utils/getClosest"),u=e("../utils/insertAfter")
t.exports=i},{"../utils/getClosest":26,"../utils/insertAfter":28,"./createButton":19,basicmodal:2,"medium-editor":12}],21:[function(e,t,n){"use strict"
var i=e("./createContentActions")
t.exports=function(e,t){var n=document.createElement("div"),o=i(t)
return n.className="w-content-container",n.appendChild(o),n.appendChild(e),n}},{"./createContentActions":20}],22:[function(e,t,n){"use strict"
...
t.exports=function(e,t){var n=document.getElementById(e),a=t&&t.editorOptions,l=t&&t.snippetsPath
return l?(fetch(l).then(function(e){return e.text()}).then(function(e){o(e),i(n)}).then(function(){r(n,a)}).catch(function(e){return console.log(e)}),{exportHtml:function(){return s(n)}}):void new Error("snippets path missing")}},{"./components/createBarActions":18,"./components/createSnippetContainer":22,"./dragNDrop":23,"./utils/getContents":27}],25:[function(e,t,n){"use strict"
var i=e("./init")
window&&(window.WebEdit=i)},{"./init":24}],26:[function(e,t,n){"use strict"
...
return null}},{}],27:[function(e,t,n){"use strict"
var i=e("htmlencode").htmlEncode
t.exports=function(e){var t="",n=e.querySelectorAll(".w-snippet")
return n.forEach(function(e){t+=e.innerHTML}),i(t)}},{htmlencode:11}],28:[function(e,t,n){"use strict"
t.exports=function(e,t){t.parentNode.insertBefore(e,t.nextSibling)}},{}]},{},[25])
