...
function i(e){return e&&e.__esModule?e:{default:e}}function o(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:[],n=arguments.length>2&&void 0!==arguments[2]?arguments[2]:[],i=document.createElement("div")
i.className="w-bar-container",t.forEach(function(e){var t=e.width.replace("px","")||"",n=e.height.replace("px","")||"",o=e.label||t+"x"+n,r=(0,s.default)(o,"w-btn-viewport"),a={width:t,height:n};(0,u.default)(r,a),i.appendChild(r)})
var o=(0,s.default)("","w-btn-export fa fa-code");(0,l.default)(o,e),i.appendChild(o),n.forEach(function(e){var t=(0,s.default)(e.label,"w-btn "+(e.class||""),e.id)
t.addEventListener("click",e.fn),i.appendChild(t)}),document.body.appendChild(i)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o
