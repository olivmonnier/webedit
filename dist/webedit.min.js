...
n.className="w-bar-container",e.forEach(function(e){var t=e.width.replace("px","")||"",i=e.height.replace("px","")||"",o=e.label||t+"x"+i,r=(0,s.default)(o,"w-btn-viewport"),a={width:t,height:i};(0,u.default)(r,a),n.appendChild(r)})
var i=(0,s.default)("","w-btn-export fa fa-code");(0,l.default)(i),n.appendChild(i),t.forEach(function(e){var t=(0,s.default)(e.label,"w-btn "+(e.class||""),e.id)
...
function i(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e){var t=document.body
e.addEventListener("click",function(e){var n=(0,r.default)(t)
a.show({body:"<pre>"+n+"</pre>",class:"modal-export",buttons:{action:{title:"Close",fn:a.close}}})})}
var o=e("../utils/getContents"),r=i(o),s=e("../utils/getClosest"),a=(i(s),e("basicmodal"))},{"../utils/getClosest":36,"../utils/getContents":37,basicmodal:2}],29:[function(e,t,n){"use strict"
...
return(0,f.default)(document),o.forEach(function(e){return e.classList.add("w-contents-container")}),u?(i=Array.isArray(u)?u:[u],n=i.map(function(e){return{url:e.url||e,label:e.label||""}}),Promise.all(n.map(function(e){return fetch(e.url,{method:"GET",mode:"cors"})})).then(function(e){Promise.all(e.map(function(e){return e.text()})).then(function(e){(0,a.default)(e,n),(0,r.default)(t.viewports,t.buttons)}).then(function(){(0,c.default)(o,l)}).catch(function(e){return console.log(e)})}),{exportHtml:function(){var e=document.body
return(0,d.default)(e)}}):void new Error("snippets path missing")}
...
window&&(window.WebEdit=window.opener?a.default:r.default)},{"./initEdit":33,"./initRender":34}],36:[function(e,t,n){"use strict"
