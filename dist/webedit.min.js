...
o(x,t,"mousedown",S),o(x,t,"mouseup",O)}function a(e){var t=e?"remove":"add"
o(x,t,"mousemove",A)}function p(e){var t=e?"remove":"add"
E[t](x,"selectstart",T),E[t](x,"click",T)}function v(){i(!0),O({})}function T(e){ae&&e.preventDefault()}function S(e){te=e.clientX,ne=e.clientY
var t=1!==r(e)||e.metaKey||e.ctrlKey
if(!t){var n=e.target,i=k(n)
i&&(ae=i,a(),"mousedown"===e.type&&(m(n)?n.focus():e.preventDefault()))}}function A(e){if(ae){if(0===r(e))return void O({})
if(void 0===e.clientX||e.clientX!==te||void 0===e.clientY||e.clientY!==ne){if(ce.ignoreInputTextSelection){var t=b("clientX",e),n=b("clientY",e),i=w.elementFromPoint(t,n)
if(m(i))return}var o=ae
a(!0),p(),B(),D(o)
var l=s(J)
Z=b("pageX",e)-l.left,ee=b("pageY",e)-l.top,C.add(re||J,"gu-transit"),z(),q(e)}}}function k(e){if(!(ue.dragging&&Q||n(e))){for(var t=e;f(e)&&n(f(e))===!1;){if(ce.invalid(e,t))return
...
t&&D(t)}function D(e){X(e.item,e.source)&&(re=e.item.cloneNode(!0),ue.emit("cloned",re,e.item,"copy")),G=e.source,J=e.item,ie=oe=g(e.item),ue.dragging=!0,ue.emit("drag",J,G)}function M(){return!1}function B(){if(ue.dragging){var e=re||J
F(e,f(e))}}function P(){ae=!1,a(!0),p(!0)}function O(e){if(P(),ue.dragging){var t=re||J,n=b("clientX",e),i=b("clientY",e),o=l(Q,n,i),r=K(o,n,i)
r&&(re&&ce.copySortSource||!re||r!==G)?F(t,r):ce.removeOnSpill?R():I()}}function F(e,t){var n=f(e)
re&&ce.copySortSource&&t===G&&n.removeChild(J),_(t)?ue.emit("cancel",e,G,G):ue.emit("drop",e,t,G,oe),H()}function R(){if(ue.dragging){var e=re||J,t=f(e)
t&&t.removeChild(e),ue.emit(re?"cancel":"remove",e,t,G),H()}}function I(e){if(ue.dragging){var t=arguments.length>0?e:ce.revertOnSpill,n=re||J,i=f(n),o=_(i)
o===!1&&t&&(re?i&&i.removeChild(re):G.insertBefore(n,ie)),o||t?ue.emit("cancel",n,G,G):ue.emit("drop",n,i,G,oe),H()}}function H(){var e=re||J
P(),W(),e&&C.rm(e,"gu-transit"),se&&clearTimeout(se),ue.dragging=!1,le&&ue.emit("out",e,le,G),ue.emit("dragend",e),G=J=re=ie=oe=se=le=null}function _(e,t){var n
return n=void 0!==t?t:Q?oe:g(re||J),e===G&&n===ie}function K(e,t,i){function o(){var o=n(r)
if(o===!1)return!1
var s=V(r,e),a=$(r,s,t,i),l=_(r,a)
...
var c=re||J,u=l(Q,o,r),d=K(u,o,r),h=null!==d&&d!==le;(h||null===d)&&(i(),le=d,n())
var m=f(c)
if(d===G&&re&&!ce.copySortSource)return void(m&&m.removeChild(c))
var p,v=V(d,u)
if(null!==v)p=$(d,v,o,r)
else{if(ce.revertOnSpill!==!0||re)return void(re&&m&&m.removeChild(c))
p=ie,d=G}(null===p&&h||p!==c&&p!==g(c))&&(oe=p,d.insertBefore(c,p),ue.emit("shadow",c,d,G))}}function j(e){C.rm(e,"gu-hide")}function U(e){ue.dragging&&C.add(e,"gu-hide")}function z(){if(!Q){var e=J.getBoundingClientRect()
Q=J.cloneNode(!0),Q.style.width=d(e)+"px",Q.style.height=h(e)+"px",C.rm(Q,"gu-transit"),C.add(Q,"gu-mirror"),ce.mirrorContainer.appendChild(Q),o(x,"add","mousemove",q),C.add(ce.mirrorContainer,"gu-unselectable"),ue.emit("cloned",Q,J,"mirror")}}function W(){Q&&(C.rm(ce.mirrorContainer,"gu-unselectable"),o(x,"remove","mousemove",q),f(Q).removeChild(Q),Q=null)}function V(e,t){for(var n=t;n!==e&&f(n)!==e;)n=f(n)
...
void 0===ce.moves&&(ce.moves=u),void 0===ce.accepts&&(ce.accepts=u),void 0===ce.invalid&&(ce.invalid=M),void 0===ce.containers&&(ce.containers=e||[]),void 0===ce.isContainer&&(ce.isContainer=c),void 0===ce.copy&&(ce.copy=!1),void 0===ce.copySortSource&&(ce.copySortSource=!1),void 0===ce.revertOnSpill&&(ce.revertOnSpill=!1),void 0===ce.removeOnSpill&&(ce.removeOnSpill=!1),void 0===ce.direction&&(ce.direction="vertical"),void 0===ce.ignoreInputTextSelection&&(ce.ignoreInputTextSelection=!0),void 0===ce.mirrorContainer&&(ce.mirrorContainer=w.body)
var ue=y({containers:ce.containers,start:L,end:B,cancel:I,remove:R,destroy:v,canMove:N,dragging:!1})
return ce.removeOnSpill===!0&&ue.on("over",j).on("out",U),i(),ue}function o(e,t,i,o){var r={mouseup:"touchend",mousedown:"touchstart",mousemove:"touchmove"},s={mouseup:"pointerup",mousedown:"pointerdown",mousemove:"pointermove"},a={mouseup:"MSPointerUp",mousedown:"MSPointerDown",mousemove:"MSPointerMove"}
...
return{left:t.left+a("scrollLeft","pageXOffset"),top:t.top+a("scrollTop","pageYOffset")}}function a(e,t){return"undefined"!=typeof n[t]?n[t]:x.clientHeight?x[e]:w.body[e]}function l(e,t,n){var i,o=e||{},r=o.className
return o.className+=" gu-hide",i=w.elementFromPoint(t,n),o.className=r,i}function c(){return!1}function u(){return!0}function d(e){return e.width||e.right-e.left}function h(e){return e.height||e.bottom-e.top}function f(e){return e.parentNode===w?null:e.parentNode}function m(e){return"INPUT"===e.tagName||"TEXTAREA"===e.tagName||"SELECT"===e.tagName||p(e)}function p(e){return!!e&&("false"!==e.contentEditable&&("true"===e.contentEditable||p(f(e))))}function g(e){function t(){var t=e
do t=t.nextSibling
...
return e in i&&!(e in n)&&i[e]in n&&(e=i[e]),n[e]}var y=e("contra/emitter"),E=e("crossvent"),C=e("./classes"),w=document,x=w.documentElement
...
var o=e.util.guid()
t.setAttribute("data-medium-editor-element",!0),t.classList.add("medium-editor-element"),t.setAttribute("role","textbox"),t.setAttribute("aria-multiline",!0),t.setAttribute("data-medium-editor-editor-index",i),t.setAttribute("medium-editor-index",o),k[o]=t.innerHTML,this.events.attachAllEventsToElement(t)}return t}function w(){this.subscribe("editableKeydownTab",i.bind(this)),this.subscribe("editableKeydownDelete",o.bind(this)),this.subscribe("editableKeydownEnter",o.bind(this)),this.options.disableExtraSpaces&&this.subscribe("editableKeydownSpace",t.bind(this)),this.instanceHandleEditableKeydownEnter||(this.options.disableReturn||this.options.disableDoubleReturn)&&(this.instanceHandleEditableKeydownEnter=n.bind(this),this.subscribe("editableKeydownEnter",this.instanceHandleEditableKeydownEnter))}function x(){if(this.extensions=[],Object.keys(this.options.extensions).forEach(function(e){"toolbar"!==e&&this.options.extensions[e]&&this.extensions.push(h(this.options.extensions[e],e,this))},this),y.call(this)){var t=this.options.fileDragging
...
return arguments.length>=3&&(i.depth=arguments[2]),arguments.length>=4&&(i.colors=arguments[3]),p(t)?i.showHidden=t:t&&n._extend(i,t),C(i.showHidden)&&(i.showHidden=!1),C(i.depth)&&(i.depth=2),C(i.colors)&&(i.colors=!1),C(i.customInspect)&&(i.customInspect=!0),i.colors&&(i.stylize=r),l(i,e,i.depth)}function r(e,t){var n=o.styles[t]
...
return e.stylize("[Function"+g+"]","special")}if(w(t))return e.stylize(RegExp.prototype.toString.call(t),"regexp")
if(T(t))return e.stylize(Date.prototype.toString.call(t),"date")
if(S(t))return u(t)}var v="",b=!1,E=["{","}"]
if(m(t)&&(b=!0,E=["[","]"]),A(t)){var C=t.name?": "+t.name:""
v=" [Function"+C+"]"}if(w(t)&&(v=" "+RegExp.prototype.toString.call(t)),T(t)&&(v=" "+Date.prototype.toUTCString.call(t)),S(t)&&(v=" "+u(t)),0===s.length&&(!b||0==t.length))return E[0]+v+E[1]
if(i<0)return w(t)?e.stylize(RegExp.prototype.toString.call(t),"regexp"):e.stylize("[Object]","special")
e.seen.push(t)
var x
return x=b?d(e,t,i,p,s):s.map(function(n){return h(e,t,i,p,n,b)}),e.seen.pop(),f(x,v,E)}function c(e,t){if(C(t))return e.stylize("undefined","undefined")
...
return o>60?n[0]+(""===t?"":t+"\n ")+" "+e.join(",\n  ")+" "+n[1]:n[0]+t+" "+e.join(", ")+" "+n[1]}function m(e){return Array.isArray(e)}function p(e){return"boolean"==typeof e}function g(e){return null===e}function v(e){return null==e}function b(e){return"number"==typeof e}function y(e){return"string"==typeof e}function E(e){return"symbol"==typeof e}function C(e){return void 0===e}function w(e){return x(e)&&"[object RegExp]"===N(e)}function x(e){return"object"==typeof e&&null!==e}function T(e){return x(e)&&"[object Date]"===N(e)}function S(e){return x(e)&&("[object Error]"===N(e)||e instanceof Error)}function A(e){return"function"==typeof e}function k(e){return null===e||"boolean"==typeof e||"number"==typeof e||"string"==typeof e||"symbol"==typeof e||"undefined"==typeof e}function N(e){return Object.prototype.toString.call(e)}function L(e){return e<10?"0"+e.toString(10):e.toString(10)}function D(){var e=new Date,t=[L(e.getHours()),L(e.getMinutes()),L(e.getSeconds())].join(":")
return[e.getDate(),F[e.getMonth()],t].join(" ")}function M(e,t){return Object.prototype.hasOwnProperty.call(e,t)}var B=/%[sdj%]/g
n.format=function(e){if(!y(e)){for(var t=[],n=0;n<arguments.length;n++)t.push(o(arguments[n]))
return t.join(" ")}for(var n=1,i=arguments,r=i.length,s=String(e).replace(B,function(e){if("%%"===e)return"%"
if(n>=r)return e
...
t.traceDeprecation?console.trace(o):console.error(o),s=!0}return e.apply(this,arguments)}if(C(i.process))return function(){return n.deprecate(e,o).apply(this,arguments)}
if(t.noDeprecation===!0)return e
var s=!1
return r}
var P,O={}
n.debuglog=function(e){if(C(P)&&(P=t.env.NODE_DEBUG||""),e=e.toUpperCase(),!O[e])if(new RegExp("\\b"+e+"\\b","i").test(P)){var i=t.pid
O[e]=function(){var t=n.format.apply(n,arguments)
console.error("%s %d: %s",e,i,t)}}else O[e]=function(){}
return O[e]},n.inspect=o,o.colors={bold:[1,22],italic:[3,23],underline:[4,24],inverse:[7,27],white:[37,39],grey:[90,39],black:[30,39],blue:[34,39],cyan:[36,39],green:[32,39],magenta:[35,39],red:[31,39],yellow:[33,39]},o.styles={special:"cyan",number:"yellow",boolean:"yellow",undefined:"grey",null:"bold",string:"green",date:"magenta",regexp:"red"},n.isArray=m,n.isBoolean=p,n.isNull=g,n.isNullOrUndefined=v,n.isNumber=b,n.isString=y,n.isSymbol=E,n.isUndefined=C,n.isRegExp=w,n.isObject=x,n.isDate=T,n.isError=S,n.isFunction=A,n.isPrimitive=k,n.isBuffer=e("./support/isBuffer")
...
var i=e("./createButton"),o=e("../events/clickBtnExport")
t.exports=function(e){var t=document.createElement("div"),n=i("","w-btn-export fa fa-code")
o(n,e),t.className="w-bar-container",t.appendChild(n),document.body.appendChild(t)}},{"../events/clickBtnExport":26,"./createButton":19}],19:[function(e,t,n){"use strict"
t.exports=function(e,t,n){var i=document.createElement("button")
return i.textContent=e,t&&(i.className=t),n&&(i.id=n),i}},{}],20:[function(e,t,n){"use strict"
function i(e){var t=document.createElement("div"),n=s("","w-btn-move fa fa-arrows"),i=s("","w-btn-delete fa fa-trash"),r=s("","w-btn-duplicate fa fa-plus")
return u(i),o(r,e),t.className="w-actions",t.appendChild(n),t.appendChild(i),t.appendChild(r),t}function o(e,t){e.addEventListener("click",function(n){var o=a(e,".w-content-container"),s=o.querySelectorAll(".w-snippet")[0],u=s.innerHTML,d=o.cloneNode(!0),h=d.querySelectorAll(".w-snippet")[0],f=d.querySelectorAll(".w-actions")[0],m=document.createElement("div"),p=i(t)
c(d),f.remove(),h.remove(),m.className="w-snippet editable",m.innerHTML=u,d.appendChild(p),d.appendChild(m),l(d,o),new r(m,t)})}var r=e("medium-editor"),s=e("./createButton"),a=e("../utils/getClosest"),l=e("../utils/insertAfter"),c=e("../events/clickContent"),u=e("../events/clickBtnDelete")
t.exports=i},{"../events/clickBtnDelete":25,"../events/clickContent":28,"../utils/getClosest":31,"../utils/insertAfter":33,"./createButton":19,"medium-editor":12}],21:[function(e,t,n){"use strict"
var i=e("./createContentActions"),o=e("../events/clickContent")
t.exports=function(e,t){var n=document.createElement("div"),r=i(t)
return o(n),n.className="w-content-container",n.appendChild(r),n.appendChild(e),n}},{"../events/clickContent":28,"./createContentActions":20}],22:[function(e,t,n){"use strict"
var i=e("./createButton"),o=e("../events/clickBtnOpen")
t.exports=function(e){var t=document.createElement("div"),n=document.createElement("div"),r=i("","w-btn-open fa fa-angle-left")
o(r,t),t.className="w-aside-container",n.id="snippetsContainer",n.innerHTML=e,t.appendChild(r),t.appendChild(n),document.body.appendChild(t)}},{"../events/clickBtnOpen":27,"./createButton":19}],23:[function(e,t,n){"use strict"
var i=e("medium-editor"),o=e("dragula"),r=e("./components/createEditContainer")
t.exports=function(e,t){o([e,document.getElementById("snippetsContainer")],{copy:function(e,t){return t===document.getElementById("snippetsContainer")},accepts:function(e,t){return t!==document.getElementById("snippetsContainer")},moves:function(t,n,i){return n.id==e.id?i.classList.contains("w-btn-move"):"snippetsContainer"==n.id}}).on("drag",function(t,n){n.id!==e.id&&e.classList.add("w-hover")}).on("drop",function(n,o){if(e.classList.remove("w-hover"),!(n.querySelectorAll(".w-actions").length>0)&&o&&o.id==e.id){var s=n.parentNode,a=n.cloneNode(!0),l=a.querySelectorAll(".w-snippet")[0]
l&&(l.className+=" editable",s.replaceChild(r(l,t),n),new i(l,t))}})}},{"./components/createEditContainer":21,dragula:9,"medium-editor":12}],24:[function(e,t,n){"use strict"
t.exports=function(e){e.addEventListener("click",function(){document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")})})}},{}],25:[function(e,t,n){"use strict"
var i=e("basicmodal"),o=e("../utils/getClosest")
t.exports=function(e){e.addEventListener("click",function(t){var n=o(e,".w-content-container")
i.show({body:"<p><strong>Are you sure ?</strong></p>",buttons:{cancel:{title:"Cancel",fn:i.close},action:{title:"Continue",fn:function(){n.remove(),i.close()}}}})})}},{"../utils/getClosest":31,basicmodal:2}],26:[function(e,t,n){"use strict"
var i=e("basicmodal"),o=e("../utils/getContents")
t.exports=function(e,t){e.addEventListener("click",function(e){var n=o(t)
i.show({body:"<pre>"+n+"</pre>",buttons:{action:{title:"Close",fn:i.close}}})})}},{"../utils/getContents":32,basicmodal:2}],27:[function(e,t,n){"use strict"
t.exports=function(e,t){e.addEventListener("click",function(n){var i=e.classList
i.toggle("in"),t.classList.toggle("in"),i.contains("in")?(i.remove("fa-angle-left"),i.add("fa-angle-right")):(i.remove("fa-angle-right"),i.add("fa-angle-left"))})}},{}],28:[function(e,t,n){"use strict"
t.exports=function(e){e.addEventListener("click",function(t){t.stopPropagation(),document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")}),e.classList.add("w-focus")})}},{}],29:[function(e,t,n){"use strict"
var i=e("./components/createBarActions"),o=e("./components/createSnippetContainer"),r=e("./dragNDrop"),s=e("./utils/getContents"),a=e("./events/clickBody")
t.exports=function(e,t){var n=document.getElementById(e),l=t&&t.editorOptions,c=t&&t.snippetsPath,u=document.getElementsByTagName("body")[0]
return a(u),c?(fetch(c).then(function(e){return e.text()}).then(function(e){o(e),i(n)}).then(function(){r(n,l)}).catch(function(e){return console.log(e)}),{exportHtml:function(){return s(n)}}):void new Error("snippets path missing")}},{"./components/createBarActions":18,"./components/createSnippetContainer":22,"./dragNDrop":23,"./events/clickBody":24,"./utils/getContents":32}],30:[function(e,t,n){"use strict"
var i=e("./init")
window&&(window.WebEdit=i)},{"./init":29}],31:[function(e,t,n){"use strict"
...
return null}},{}],32:[function(e,t,n){"use strict"
var i=e("htmlencode").htmlEncode
t.exports=function(e){var t="",n=e.querySelectorAll(".w-snippet")
return n.forEach(function(e){t+=e.innerHTML}),i(t)}},{htmlencode:11}],33:[function(e,t,n){"use strict"
t.exports=function(e,t){t.parentNode.insertBefore(e,t.nextSibling)}},{}]},{},[30])
