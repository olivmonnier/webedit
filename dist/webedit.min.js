...
a(!0),p(),P(),D(o)
var l=s(J)
Z=b("pageX",e)-l.left,ee=b("pageY",e)-l.top,C.add(re||J,"gu-transit"),z(),K(e)}}}function k(e){if(!(ue.dragging&&Q||n(e))){for(var t=e;f(e)&&n(f(e))===!1;){if(ce.invalid(e,t))return
...
var r=e("./createButton"),s=i(r),a=e("../events/clickBtnExport"),l=i(a)},{"../events/clickBtnExport":27,"./createButton":19}],19:[function(e,t,n){"use strict"
...
var r=e("./createButton"),s=i(r),a=e("../events/clickBtnDelete"),l=i(a),c=e("../events/clickBtnDuplicate"),u=i(c)},{"../events/clickBtnDelete":25,"../events/clickBtnDuplicate":26,"./createButton":19}],21:[function(e,t,n){"use strict"
...
var r=e("./createContentActions"),s=i(r),a=e("../events/clickContent"),l=i(a)},{"../events/clickContent":29,"./createContentActions":20}],22:[function(e,t,n){"use strict"
function i(e,t){for(var n=document.createElement("select"),i=0;i<e;i++){var o=document.createElement("option")
o.setAttribute("value",i),o.textContent=i,n.appendChild(o)}t.appendChild(n)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i},{}],23:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}function o(e){var t=document.createElement("div"),n=document.createElement("div"),i=(0,s.default)("","w-btn-open fa fa-angle-left");(0,u.default)(i,t),e.forEach(function(e,t){var i=document.createElement("div")
i.className="w-list-snippets",i.setAttribute("data-index",t),i.innerHTML=e,n.appendChild(i)}),e.length>1&&(0,l.default)(e.length,t),t.className="w-aside-container",n.className="w-snippets-container",t.appendChild(i),t.appendChild(n),document.body.appendChild(t)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=o
var r=e("./createButton"),s=i(r),a=e("./createSelectorSnippets"),l=i(a),c=e("../events/clickBtnOpen"),u=i(c)},{"../events/clickBtnOpen":28,"./createButton":19,"./createSelectorSnippets":22}],24:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}function o(e,t){var n=[].slice.call(document.querySelectorAll(".w-list-snippets"))
n.push(e),l(n,{copy:function(e,t){return"w-list-snippets"===t.className},accepts:function(e,t){return"w-list-snippets"!==t.className},moves:function(t,n,i){return n.id==e.id?i.classList.contains("w-btn-move"):"w-list-snippets"==n.className}}).on("drag",function(t,n){n.id!==e.id&&e.classList.add("w-hover")}).on("drop",function(n,i){if(e.classList.remove("w-hover"),!(n.querySelectorAll(".w-actions").length>0)&&i&&i.id==e.id){var o=n.parentNode,r=n.cloneNode(!0),l=r.querySelectorAll(".w-snippet")[0]
...
var o=e("../utils/getClosest"),r=i(o),s=e("basicmodal")},{"../utils/getClosest":33,basicmodal:2}],26:[function(e,t,n){"use strict"
...
var o=e("../components/createEditContainer"),r=i(o),s=e("../utils/getClosest"),a=i(s),l=e("../utils/insertAfter"),c=i(l),u=e("medium-editor")},{"../components/createEditContainer":21,"../utils/getClosest":33,"../utils/insertAfter":35,"medium-editor":12}],27:[function(e,t,n){"use strict"
...
var o=e("../utils/getContents"),r=i(o),s=e("basicmodal")},{"../utils/getContents":34,basicmodal:2}],28:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e,t){e.addEventListener("click",function(n){var i=e.classList
i.toggle("in"),t.classList.toggle("in"),i.contains("in")?(i.remove("fa-angle-left"),i.add("fa-angle-right")):(i.remove("fa-angle-right"),i.add("fa-angle-left"))})}},{}],29:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e){e.addEventListener("click",function(t){t.stopPropagation(),document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")}),e.classList.add("w-focus")})}},{}],30:[function(e,t,n){"use strict"
Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e){e.addEventListener("click",function(){document.querySelectorAll(".w-focus").forEach(function(e){e.classList.remove("w-focus")})})}},{}],31:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(n,"__esModule",{value:!0}),n.default=function(e,t){var n=[],i=document.getElementById(e),o=t&&t.editorOptions,s=t&&t.snippetsPath
return(0,f.default)(document),s?(n=Array.isArray(s)?s:[s],Promise.all(n.map(function(e){return fetch(e,{method:"GET"})})).then(function(e){Promise.all(e.map(function(e){return e.text()})).then(function(e){(0,a.default)(e),(0,r.default)(i)}).then(function(){(0,c.default)(i,o)}).catch(function(e){return console.log(e)})}),{exportHtml:function(){return(0,d.default)(i)}}):void new Error("snippets path missing")}
var o=e("./components/createBarActions"),r=i(o),s=e("./components/createSnippetContainer"),a=i(s),l=e("./dragNDrop"),c=i(l),u=e("./utils/getContents"),d=i(u),h=e("./events/clickDocument"),f=i(h)},{"./components/createBarActions":18,"./components/createSnippetContainer":23,"./dragNDrop":24,"./events/clickDocument":30,"./utils/getContents":34}],32:[function(e,t,n){"use strict"
function i(e){return e&&e.__esModule?e:{default:e}}var o=e("./init"),r=i(o)
window&&(window.WebEdit=r.default)},{"./init":31}],33:[function(e,t,n){"use strict"
...
return null}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i},{}],34:[function(e,t,n){"use strict"
...
var o=e("htmlencode").htmlEncode},{htmlencode:11}],35:[function(e,t,n){"use strict"
function i(e,t){t.parentNode.insertBefore(e,t.nextSibling)}Object.defineProperty(n,"__esModule",{value:!0}),n.default=i},{}]},{},[32])
